...
async def get_expense_categories(
    expense_category_service: ExpenseCategoryService = Depends(),
):
...
async def get_expense_category(
    ...
    expense_category = expense_category_service.get_expense_category_by_id(
        expense_category_id
    )
...
async def create_expense_category(
    ...
    new_expense_category = expense_category_service.create_expense_category(
        expense_category_form_data
    )
...
async def update_expense_category(
    ...
    updated_expense_category = expense_category_service.update_expense_category(
        expense_category_id, expense_category_form_data
    )
...
async def delete_expense_category(
    ...
    deleted_expense_category_id = expense_category_service.delete_expense_category(
        expense_category_id
    )
